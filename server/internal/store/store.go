...
CREATE TABLE IF NOT EXISTS events (
  ...
  at TEXT NOT NULL, user_id INTEGER, kind TEXT NOT NULL,
  target TEXT NOT NULL DEFAULT '', ms INTEGER NOT NULL DEFAULT 0,
  ok INTEGER NOT NULL DEFAULT 1, detail TEXT NOT NULL DEFAULT '', meta TEXT
);
